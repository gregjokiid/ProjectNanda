...
<?php
    ...
    if (isset($_POST['download'])) {
        ...
        $pdf->Cell(60,20,'Laporan Barang Keluar');
        $pdf->Ln();

        $id=$_GET['id'];
        $sql_kategori = "SELECT barang.id as id,barang.nama as nama, kategori.nama as kategori, detail_keluar.stok FROM detail_keluar
                            JOIN barang ON barang.id = detail_keluar.id_barang
                            JOIN kategori ON barang.id_kategori = kategori.id
                            WHERE detail_keluar.id='$id'";
    ...
    <div id="wrapper">
        ...
        <div id="content-wrapper" class="d-flex flex-column">
            ...
            <div class="row">
                <div class="col">
                    <div class="container">
                        <div class="h1">Kode Barang Keluar BK<?php echo $_GET['id'] ?></div>
