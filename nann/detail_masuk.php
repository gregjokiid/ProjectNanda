...
<?php
    ...
    if (isset($_POST['download'])) {
        ...
        $pdf->Cell(60,20,'Laporan Barang Masuk');
        $pdf->Ln();

        $id=$_GET['id'];
        $sql_kategori = "SELECT barang.id as id,barang.nama as nama, kategori.nama as kategori, detail_masuk.stok FROM detail_masuk 
    ...
    <div id="wrapper">
        ...
        <div id="content-wrapper" class="d-flex flex-column">
            ...
            <div class="row">
                <div class="col">
                    <div class="container">
                        <div class="h1">Kode Barang Masuk BM<?php echo $_GET['id'] ?></div>
