        ...
        if (isset($_POST['tambah'])) {
            ...
            if (mysqli_query($conn, $sql_tambah_transaksi)) {
                ...
                foreach( $barang as $key => $n ) {            
                    $sql_tambah_detail_transaksi = "INSERT INTO detail_masuk (id,id_barang,stok) VALUES ('$total','$n','$stok[$key]')";
    ...
    <div id="wrapper">
        ...
        <div id="content-wrapper" class="d-flex flex-column">
            ...
            <div class="row">
                <div class="col-6">
                    <div class="container">
                        <div class="h1">List Barang Masuk</div>
                        <table class="table table-striped border" >
                            ...
                            while($row = mysqli_fetch_array($result)){
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <a href="detail_masuk.php?id=<?php echo $row['id']; ?>">DETAIL</a>
                                    </td>
                                </tr>
                               <?php
                            } 
